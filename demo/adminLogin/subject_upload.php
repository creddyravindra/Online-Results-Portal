...
if (isset($_FILES['csv_file']['name'])) {
    ...
    if (($handle = fopen($file_temp, "r")) !== FALSE) {
        ...
        fclose($handle);
        header("Location: subject_upload3.html?notification=CSV%20file%20data%20imported%20successfully!");
        exit();
    } else {
    ...
    header("Location: subject_upload3.html?notification=Manual%20data%20imported%20successfully!");
    exit();
}
